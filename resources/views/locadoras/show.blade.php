    ...
    <x-card-show header="Locadoras">
        <div class="row align-items-center pt-4 pb-3">
            <div class="px-5 py-4">
                ...
                <hr class="mx-n3">
                <h6 class="mb-0">Cep: {{ $locadora->endereco->cep }}</h6>
                <hr class="mx-n3">
                <h6 class="mb-0">Rua: {{ $locadora->endereco->rua }}</h6>
                <hr class="mx-n3">
                <h6 class="mb-0">Número: {{ $locadora->endereco->numero }}</h6>
                <hr class="mx-n3">
                <h6 class="mb-0">Bairro: {{ $locadora->endereco->bairro }}</h6>
                <hr class="mx-n3">
                <h6 class="mb-0">Cidade: {{ $locadora->endereco->cidade }}</h6>
                <hr class="mx-n3">
                <h6 class="mb-0">Estado: {{ $locadora->endereco->estado }}</h6>
                <hr class="mx-n3">
